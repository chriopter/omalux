...
fn set_scalar(
    ...
    match id {
        ...
        "color_table.strength" => settings.color_table.strength = value,
        ...
        "effects.luminance_noise_reduction" => settings.effects.luminance_noise_reduction = value,
        "effects.colour_noise_reduction" => settings.effects.colour_noise_reduction = value,
