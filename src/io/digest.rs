...
const DOMAIN: &[u8] = b"io.omacom.omalux/source-digest/v1\0";
...
mod tests {
    ...
    fn bytes_are_content_sensitive_and_streaming_stable() {
        ...
        assert_eq!(
            a.0,
            [
                0xdf, 0x00, 0x01, 0x5f, 0x32, 0xce, 0xcc, 0x97, 0x98, 0xb4, 0x1f, 0x6d, 0x8d, 0x03,
                0xfd, 0x07, 0x64, 0x05, 0xb4, 0x24, 0x12, 0xf2, 0x72, 0x26, 0x0f, 0xcc, 0x53, 0x51,
                0xd9, 0x72, 0x3a, 0x72,
            ]
        );
    }
