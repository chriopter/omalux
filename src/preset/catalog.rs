...
const BUILTIN_PRESETS: &[&str] = &[
    ...
    include_str!("../../presets/builtin/experimental-adams-style.json"),
    include_str!("../../presets/builtin/experimental-blitz.json"),
    include_str!("../../presets/builtin/experimental-blume.json"),
    include_str!("../../presets/builtin/experimental-c300-adbvanced.json"),
    include_str!("../../presets/builtin/experimental-kerry.json"),
    include_str!("../../presets/builtin/experimental-kirche.json"),
    include_str!("../../presets/builtin/experimental-kirche-2.json"),
    include_str!("../../presets/builtin/experimental-lampe-1.json"),
    include_str!("../../presets/builtin/experimental-mantel.json"),
    include_str!("../../presets/builtin/experimental-metallbauer.json"),
    include_str!("../../presets/builtin/experimental-pflanze.json"),
    include_str!("../../presets/builtin/experimental-street.json"),
    include_str!("../../presets/builtin/experimental-verbania.json"),
    include_str!("../../presets/builtin/film-chrome.json"),
    include_str!("../../presets/builtin/film-grain.json"),
    include_str!("../../presets/builtin/film-kodak.json"),
    include_str!("../../presets/builtin/film-matte.json"),
    include_str!("../../presets/builtin/film-negative.json"),
    include_str!("../../presets/builtin/film-polaroid.json"),
    include_str!("../../presets/builtin/film-warm.json"),
