...
4. derive `DevelopRenderContext` from the decoder's content digest and run the
   canonical `DevelopPipeline`;
...
bounded-source tests. Fake services test orchestration only.
