...
- `images/beach-volleyball.jpg`: the unchanged 1536 × 1024 AI-generated beach volleyball image from Omalux v0. Used when `development/start` receives no image argument. It is not a measured colour reference.
