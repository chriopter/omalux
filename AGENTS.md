...
- `omalux/` contains the Qt/QML UI, C/C++ native adapter and Python development launcher. Brightness is connected to darktable; other editing tools remain placeholders. Do not describe planned functionality as released.
