...
- `omalux/` contains a minimal Qt/QML Hello World UI and Python development launcher. The production adapter is not integrated yet. Do not describe planned functionality as released.
