...
Each bundled style sets or disables the same seven modules (exposure, colisa, shadhi, lut3d, grain, vignette, sharpen), so switching looks clears the previous look's LUT/effects. Like every preset, Neutral first restores the opening baseline, then resets this seven-module family.
