...
static const OmControl om_controls[] = {
  ...
  {"highlights_chroma", "chroma", "colorbalancergb", "highlights_C", 0, 100, 1, 0, 0.01, 0, "%", 2, "Color", "color balance rgb \u00b7 highlights gain", "gain/chroma", "saturation", 0, 0, 20},
  {"highlights_hue", "hue", "colorbalancergb", "highlights_H", 0, 360, 1, 0, 1, 0, "\u00b0", 2, "Color", "color balance rgb \u00b7 highlights gain", "gain/hue", "hue", 0},
  {"shadows_chroma", "chroma", "colorbalancergb", "shadows_C", 0, 100, 1, 0, 0.01, 0, "%", 2, "Color", "color balance rgb \u00b7 shadows lift", "lift/chroma", "saturation", 0, 0, 50},
